...
void TopicSubscriber::SubListener::on_subscription_matched(
        DataReader*,
...
void TopicSubscriber::SubListener::on_data_available(
        DataReader* reader)
{
    // Take data
    Topic st;
